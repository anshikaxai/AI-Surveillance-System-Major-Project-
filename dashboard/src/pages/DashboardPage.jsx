...
import CCTV2Feed from '../components/CCTV2Feed';
...
return (
  <div className="space-y-5">
    ...
    <div className="flex items-center justify-between flex-wrap gap-3">
      <div>
        ...
        <p className="text-sm text-white/50 mt-1">
          Real-time perception → explainable event intelligence
        </p>
      </div>
    ...
    <div className="grid xl:grid-cols-2 gap-5">
      ...
      {/* CCTV 1 - Basement / Vehicle Analytics */}
      <LiveFeed />

      {/* CCTV 2 - Human Activity Analytics */}
      <CCTV2Feed />
      ...
      <div className="lg:col-span-3 space-y-5">
        ...
        <div className="card p-5 animate-slide_in">
          ...
          <h3 className="font-semibold text-white mb-3">
            Pipeline Flow (Layered Architecture)
          </h3>
